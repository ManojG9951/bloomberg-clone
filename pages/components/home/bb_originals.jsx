...
function BBOriginals({ articles }) {
  ...
  return (
    <Container fluid className={`${colorMode ? "dark-mode":"light-mode"} ${styles.bboriginals_mainContainer}`}>
      <Col>
        <Row className="py-3">
          <div className="d-flex justify-content-start align-items-end">
            <h1 style={{ fontWeight: "700" }}>
              Bloomberg <span style={{ fontWeight: "400", letterSpacing:"3px" }} className="text-secondary">ORIGINALS</span>
            </h1>
